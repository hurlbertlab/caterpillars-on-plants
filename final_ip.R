...
joined_try[joined_try$sciName == 'Prunus serrulata',]

#trying to drop duplicate names based on scientific names
dropped_duplicates_joined_try <- joined_try[!duplicated(joined_try$sciName), ]
