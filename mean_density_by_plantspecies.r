...
#meanDensity, meanBiomass, fracSurveys for all Rosaceae family
rosaceaeNative = filter(clean_and_tallamy, Family == "Rosaceae", origin == "native")
rosaceaeAlien = filter(clean_and_tallamy, Family == "Rosaceae", origin == 'alien')
...
#meanDensity, meanBiomass, fracSurveys for all Ericaceae family
...
t.test(log10(ericaceaeNative$meanDensity + 0.001), log10(ericacaeAlien$meanDensity + 0.001))
...
#meanDensity, meanBiomass, fracSurveys for all Moraceae family
...
#meanDensity, meanBiomass, fracSurveys for all Oleaceae family
...
#meanDensity, meanBiomass, fracSurveys for all Ulmaceae family
